...
# lets create a board object to represent the mindsweeper game
...
class Board:
    ...
    def make_new_board(self):
        ...
        # we should construct the list of list here (or whatever representation you
        # prefer, but since we have a 2-D board, list of lists is most natural)
        ...
        while bombs_planted < self.num_bombs:
            loc = random.randint(
                0, self.dim_size**2 -
                1)  #return a random integer N since that a <= N <= b
    ...
    def dig(self, row, col):
        ...
        # dig at location with neighboring bombs -> finsh dig
    ...
    def __str__(self):
        ...
        for idx in range(self.dim_size):
            columns = [col for col in map(lambda x: x[idx], visible_board)]
...
def play(dim_size=10, num_bombs=10):
    ...
    # Step 4: repeat steps 2 and 3 until there are no more places to dig -> VICOTRY!
    safe = True
